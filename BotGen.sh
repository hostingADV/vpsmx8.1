...
ShellBot.InlineKeyboardButton --button 'botao_conf' --line 2 --text '♻️add reseller♻️' --callback_data '/rell'
...
ShellBot.InlineKeyboardButton --button 'botao_user' --line 1 --text '🔑 scripts' --callback_data '/keygen'
